...
> ⚠️ **Rules의 합산 10,000자 제한**: AGENTS.md와 별개로, Project Rules + Personal Rules는 합쳐 10,000자까지만 LLM에 전달됩니다 (PDF 가이드 명시). 핵심 규칙을 Project Rules 앞쪽에 두세요.

## 🛠️ 개인용 미니 실습 (5분)

> **실습 저장소**: [steps/step-1-context/](https://github.com/imakerjun/agentic-coding-sample/tree/main/steps/step-1-context) — 빈 Todo CLI 스캐폴드와 정답 예시가 들어 있습니다. 자기 프로젝트가 없거나 처음이면 이걸로 따라가세요.
...
이게 **"살아 있는 컨텍스트"** 의 시작입니다. (자세한 1주일 적용 가이드는 [Part 3.2](../part-3-how/week-one-guide))
...
- **AI Pro의 1차 파일은 AGENTS.md** (PDF 가이드), Rules는 행동 지침 보완
...
- AI Pro 사내 PDF 가이드 (Rules / CLI / Skills)
